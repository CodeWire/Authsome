...
<ol>
	...
	<li>Visit the <strong>Settings\ MyTieIn Social Login</strong> to get started,</li>  
	<li>Run the <b><a href="options-general.php?page=mytiein-infusionsoft-social-login&wslp=3">requirements test</a></b> to make sure your server settings meet this plugin requirements,</li>
</ol>  
...
<div style="text-align: center;"><img src="<?php echo MYTIEIN_INFUS_SOCIAL_LOGIN_PLUGIN_URL ?>/screenshot-3.png" style="width:700px;"></div>
...
<div style="text-align: center;"><img src="<?php echo MYTIEIN_INFUS_SOCIAL_LOGIN_PLUGIN_URL ?>/screenshot-1.png" style="width:700px;"></div>
...
<div style="text-align: center;"><img src="<?php echo MYTIEIN_INFUS_SOCIAL_LOGIN_PLUGIN_URL ?>/screenshot-2.png" style="width:700px;"></div>
...
<p style="margin-left:25px;margin:10px;"> 
	...
	<pre style="width: 500px;background-color: #FFFFE0;border:1px solid #E6DB55; border-radius: 3px;padding: 10px;margin-left:10px;"> &lt;?php do_action( 'mytiein_infusionsoft_social_login' ); ?&gt; </pre> 
</p>
</div>