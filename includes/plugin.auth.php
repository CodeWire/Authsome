...
{
	if( ! isset( $_REQUEST[ 'action' ] ) || $_REQUEST[ 'action' ] !=  "mytiein_infusionsoft_social_login" ){
		return;
	}
	...
	// Create new user and associate provider identity
		...
		$user_login = str_replace( ' ', '_', strtolower( $hybridauth_user_profile->displayName?$hybridauth_user_profile->displayName:$hybridauth_user_profile->firstName ) );
		...
		$userdata = array(
			...
			'user_nicename' => $hybridauth_user_profile->displayName?$hybridauth_user_profile->displayName:$hybridauth_user_profile->firstName,
			'display_name'  => $hybridauth_user_profile->displayName?$hybridauth_user_profile->displayName:$hybridauth_user_profile->firstName,
