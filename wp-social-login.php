<?php
/*
Plugin Name: MyTieIn Infusionsoft Social Login
Plugin URI: 
Description: Allow your visitors to login and comment with social networks and identities providers such as Facebook, Twitter and Google while importing their contact information into Infusionsoft.
Version: 1.02
Author: MyTieIn, Tom Shafer
Author URI: 
License: 
*/
...
$_SESSION["wsl::plugin"] = "MyTieIn Infusionsoft Social Login 1.02"; 
...
function wsl_add_settings_link( $links, $file ){ 
	...
	if ( $file == $this_plugin ){
		$settings_link = '<a href="options-general.php?page=mytiein-infusionsoft-social-login">Settings</a>';
...
define( 'MYTIEIN_INFUS_SOCIAL_LOGIN_PLUGIN_URL', plugins_url() . '/' . basename( dirname( __FILE__ ) ) ); 
define( 'WORDPRESS_SOCIAL_LOGIN_HYBRIDAUTH_ENDPOINT_URL', MYTIEIN_INFUS_SOCIAL_LOGIN_PLUGIN_URL . '/hybridauth/' ); 
